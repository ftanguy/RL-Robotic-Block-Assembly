...
def main():
    ...
    if args.algo == "maskppo":
        def make_env():
            base = _make_base_env()
            return Monitor(ActionMasker(base, lambda env: env.get_action_mask()))
    else:
        make_env = _make_base_env
...
def create_parser():
    ...
    parser.add_argument("--save-freq", type=int, default=20_000, help="checkpoint frequency (steps)")
